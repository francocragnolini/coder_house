...
se genera un id de orden para el usuario y en firebase se guarda la orden con los productos que compró, actualizando el stock de productos en la base de datos.
